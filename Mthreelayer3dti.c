...
int main(int argc, char* argv[])
{
        ...
        float  vp0_3, vs0_3, eps_3, del_3, gam_3, the_3, phi_3;
        float  ***w;
        ...
        if (!sf_getfloat("vs0_1",&vs0_1)) vs0_1=1500.0;
        ...
        if (!sf_getfloat("vs0_2",&vs0_2)) vs0_2=1500.0;
        ...
        if (!sf_getfloat("vs0_3",&vs0_3)) vs0_3=1500.0;
        if (!sf_getfloat("eps_3",&eps_3)) eps_3=0.2;
        if (!sf_getfloat("del_3",&del_3)) del_3=0.1;
        if (!sf_getfloat("gam_3",&gam_3)) gam_3=0.0;
        if (!sf_getfloat("the_3",&the_3)) the_3=30.0;  // Unit: degree
        if (!sf_getfloat("phi_3",&phi_3)) phi_3=0.0;
	...
	int   i,j,k;
        ...
        Fo5 = sf_output("gam"); // gama
        Fo6 = sf_output("the"); // theta
        Fo7 = sf_output("phi"); // phai
