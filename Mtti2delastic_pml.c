...
int main(int argc, char* argv[])
{
   ...
   for(k=0;k<nt;k++)
   {
	   ...
	   for(i=0;i<nz;i++)
		   ...
		   {
			   if(i<nzpad)
				   zTxx2[i][j] = exp(-alpha_z[nzpad-i-1]*dt/2)*(dt*(c13[i][j]*d3[i][j]+c15[i][j]*d2[i][j]) + exp(-alpha_z[nzpad-i-1]*dt/2)*zTxx1[i][j]);
			   else if (i>=nz-nzpad)
				   zTxx2[i][j] = exp(-alpha_z[nzpad+i-nz]*dt/2)*(dt*(c13[i][j]*d3[i][j]+c15[i][j]*d2[i][j]) +  exp(-alpha_z[nzpad+i-nz]*dt/2)*zTxx1[i][j]);
			   else
				   zTxx2[i][j] = dt*(c13[i][j]*d3[i][j]+c15[i][j]*d2[i][j]) + zTxx1[i][j];

			   if(j<nxpad)
				   xTxx2[i][j] = exp(-alpha_x[nxpad-j-1]*dt/2)*(dt*(c11[i][j]*d1[i][j]+c15[i][j]*d4[i][j]) + exp(-alpha_x[nxpad-j-1]*dt/2)*xTxx1[i][j]);
			   else if(j>=nx-nxpad)
				   xTxx2[i][j] = exp(-alpha_x[nxpad+j-nx]*dt/2)*(dt*(c11[i][j]*d1[i][j]+c15[i][j]*d4[i][j]) + exp(- alpha_x[nxpad+j-nx]*dt/2)*xTxx1[i][j]);
			   else
				   xTxx2[i][j] = dt*(c11[i][j]*d1[i][j]+c15[i][j]*d4[i][j]) + xTxx1[i][j];
			   Txx2[i][j] = xTxx2[i][j] + zTxx2[i][j];

			   if(i<nzpad)
				   zTzz2[i][j] = exp(-alpha_z[nzpad-i-1]*dt/2)*(dt*(c33[i][j]*d3[i][j]+c35[i][j]*d2[i][j]) + exp(-alpha_z[nzpad-i-1]*dt/2)*zTzz1[i][j]);
			   else if (i>=nz-nzpad)
				   zTzz2[i][j] = exp(-alpha_z[nzpad+i-nz]*dt/2)*(dt*(c33[i][j]*d3[i][j]+c35[i][j]*d2[i][j]) +  exp(-alpha_z[nzpad+i-nz]*dt/2)*zTzz1[i][j]);
			   else
				   zTzz2[i][j] = dt*(c33[i][j]*d3[i][j]+c35[i][j]*d2[i][j]) + zTzz1[i][j];

			   if(j<nxpad)
				   xTzz2[i][j] = exp(-alpha_x[nxpad-j-1]*dt/2)*(dt*(c13[i][j]*d1[i][j]+c35[i][j]*d4[i][j]) + exp(-alpha_x[nxpad-j-1]*dt/2)*xTzz1[i][j]);
			   else if(j>=nx-nxpad)
				   xTzz2[i][j] = exp(-alpha_x[nxpad+j-nx]*dt/2)*(dt*(c13[i][j]*d1[i][j]+c35[i][j]*d4[i][j]) + exp(- alpha_x[nxpad+j-nx]*dt/2)*xTzz1[i][j]);
			   else
				   xTzz2[i][j] = dt*(c13[i][j]*d1[i][j]+c35[i][j]*d4[i][j]) + xTzz1[i][j];
			   Tzz2[i][j] = xTzz2[i][j] + zTzz2[i][j];

			   if(i<nzpad)
				   zTxz2[i][j] = exp(-alpha_z[nzpad-i-1]*dt/2)*(dt*(c55[i][j]*d2[i][j]+c35[i][j]*d3[i][j]) + exp(-alpha_z[nzpad-i-1]*dt/2)*zTxz1[i][j]);
			   else if (i>=nz-nzpad)
				   zTxz2[i][j] = exp(-alpha_z[nzpad+i-nz]*dt/2)*(dt*(c55[i][j]*d2[i][j]+c35[i][j]*d3[i][j]) +  exp(-alpha_z[nzpad+i-nz]*dt/2)*zTxz1[i][j]);
			   else
				   zTxz2[i][j] = dt*(c55[i][j]*d2[i][j]+c35[i][j]*d3[i][j]) + zTxz1[i][j];

			   if(j<nxpad)
				   xTxz2[i][j] = exp(-alpha_x[nxpad-j-1]*dt/2)*(dt*(c55[i][j]*d4[i][j]+c15[i][j]*d1[i][j]) + exp(-alpha_x[nxpad-j-1]*dt/2)*xTxz1[i][j]);
			   else if(j>=nx-nxpad)
				   xTxz2[i][j] = exp(-alpha_x[nxpad+j-nx]*dt/2)*(dt*(c55[i][j]*d4[i][j]+c15[i][j]*d1[i][j]) + exp(- alpha_x[nxpad+j-nx]*dt/2)*xTxz1[i][j]);
			   else
				   xTxz2[i][j] = dt*(c55[i][j]*d4[i][j]+c15[i][j]*d1[i][j]) + xTxz1[i][j];
			   Txz2[i][j] = xTxz2[i][j] + zTxz2[i][j];
		   }
		
	   xTxx2[nz/2][nx/2] += Ricker(k*dt,20,0.04,10);
	   xTzz2[nz/2][nx/2] += Ricker(k*dt,20,0.04,10); //source term
	   zTxx2[nz/2][nx/2] += Ricker(k*dt,20,0.04,10);
	   zTzz2[nz/2][nx/2] += Ricker(k*dt,20,0.04,10); //source term
